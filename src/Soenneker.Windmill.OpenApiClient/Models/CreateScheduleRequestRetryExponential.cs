...
namespace Soenneker.Windmill.OpenApiClient.Models
{
    ...
    public partial class CreateScheduleRequestRetryExponential : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public CreateScheduleRequestRetryExponential()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Windmill.OpenApiClient.Models.CreateScheduleRequestRetryExponential"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Windmill.OpenApiClient.Models.CreateScheduleRequestRetryExponential CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Windmill.OpenApiClient.Models.CreateScheduleRequestRetryExponential();
        }
        /// <summary>
