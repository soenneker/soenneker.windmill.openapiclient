...
namespace Soenneker.Windmill.OpenApiClient.Models
{
    ...
    public partial class GetSettings200_git_sync_repositories : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories_settings? Settings { get; set; }
#nullable restore
#else
        public global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories_settings Settings { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories"/> and sets the default values.
        /// </summary>
        public GetSettings200_git_sync_repositories()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "settings", n => { Settings = n.GetObjectValue<global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories_settings>(global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories_settings.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Windmill.OpenApiClient.Models.GetSettings200_git_sync_repositories_settings>("settings", Settings);
