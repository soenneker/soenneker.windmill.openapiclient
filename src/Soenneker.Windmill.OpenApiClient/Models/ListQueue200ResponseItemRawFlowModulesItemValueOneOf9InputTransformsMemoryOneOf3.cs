...
namespace Soenneker.Windmill.OpenApiClient.Models
{
    ...
    public partial class ListQueue200ResponseItemRawFlowModulesItemValueOneOf9InputTransformsMemoryOneOf3 : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public ListQueue200ResponseItemRawFlowModulesItemValueOneOf9InputTransformsMemoryOneOf3()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Windmill.OpenApiClient.Models.ListQueue200ResponseItemRawFlowModulesItemValueOneOf9InputTransformsMemoryOneOf3"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Windmill.OpenApiClient.Models.ListQueue200ResponseItemRawFlowModulesItemValueOneOf9InputTransformsMemoryOneOf3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Windmill.OpenApiClient.Models.ListQueue200ResponseItemRawFlowModulesItemValueOneOf9InputTransformsMemoryOneOf3();
        }
        /// <summary>
