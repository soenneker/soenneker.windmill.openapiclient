...
using System;
namespace Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \w\{workspace}\jobs\run_and_stream\h\{hash}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithHashItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> PostAsync(global::Soenneker.Windmill.OpenApiClient.Models.RunAndStreamScriptByHashRequestRequestBody body, Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::Soenneker.Windmill.OpenApiClient.Models.RunAndStreamScriptByHashRequestRequestBody body, Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Windmill.OpenApiClient.Models.RunAndStreamScriptByHashRequestRequestBody body, Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Windmill.OpenApiClient.Models.RunAndStreamScriptByHashRequestRequestBody body, Action<RequestConfiguration<global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder.WithHashItemRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Windmill.OpenApiClient.W.Item.Jobs.Run_and_stream.H.Item.WithHashItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// run script by hash with GET and stream updates via SSE
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithHashItemRequestBuilderPostQueryParameters 
        {
            /// <summary>Override the cache time to live (in seconds). Can not be used to disable caching, only override with a new cache ttl</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
